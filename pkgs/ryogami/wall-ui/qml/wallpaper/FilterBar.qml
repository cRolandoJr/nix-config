    ...
    Row {
        ...
        Repeater {
            model: [
                ...
                // { type: "video", label: "VID" },  // sin backend de video
                // { type: "we", label: "WE" }       // sin Steam Workshop
            ]
        ...
        FilterButton {
            ...
            visible: false  // sin backend: ryoku-shell theme
        ...
        FilterButton {
            ...
            icon: "\u{f0599}"
            tooltip: "Light mode"
            visible: false  // sin backend: RPC wall.theme_preview, que el daemon no implementa
        ...
        FilterButton {
            ...
            icon: "\u{f0334}"
            tooltip: "Themes"
            visible: false  // sin backend: ryoku-shell theme catalog
        ...
        FilterButton {
            ...
            icon: "\u{f0b84}"
            tooltip: "Rices"
            visible: false  // sin backend: ryoku-hub rice list
            onClicked: filterBar.ricesToggled()
        }

        FilterButton {
            visible: false  // sin backend: ryoku-hub rice capture
            colors: filterBar.colors
            icon: "\u{f0193}"
